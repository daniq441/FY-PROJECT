    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-6 px-0">
            ...
            <div class="login-poster">
                ...
                <p class="text-white mb-3 lead"><i class="fas fa-angle-right"></i> Most Trusted Job Portal in Pakistan</p>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    ...
                    <h3><b>Create your free JobEnigma account</b></h3>
                ...
                <div class="login-form">
                    <form action="{{route('register')}}" method="POST">
                        ...
                        <div>
                            <small class="text-muted d-block mb-3">By clicking on 'Register' below, you are agreeing to the terms of JobEnigma!</p>
                        </div>
