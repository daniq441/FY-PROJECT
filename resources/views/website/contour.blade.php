...
@section('content')
  <section class="home-page pt-4">
    <div class="container">
    <form action="{{ route('contoursearch') }}" method="GET">
          <div class="row">
              ...
              <div class="col-sm-12">
                  <div class="input-group mb-3">
                      ...
                      <div class="input-group-append">
                          ...
                          <a href="{{ route('resetcontour') }}" class="btn btn-danger">Reset</a>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead class="thead-dark">
                <tr>
                  <th colspan="8" class="text-center">Contour Jobs</th>
                </tr>
                <tr>
                  <th>Title</th>
                  <th>Description</th>
                ...
                <tr>
                  ...
                  <td>
                    @php
                      ...
                      $limitedDescription = implode(' ', array_slice($words, 0, 7));
                    @endphp
                    {{ $limitedDescription }}
                    @if(count($words) > 7)
