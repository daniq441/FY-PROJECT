  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">JobEnigma</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> Awan town Lahore 54780, Pakistan</a>
             <a href="tel:00923218228183" class="footer-links"><i class="fas fa-phone"></i> +92-321-8228183</a>
             <a href="tel:00923218228183" class="footer-links"><i class="fas fa-mobile"></i> +92-321-8228183</a>
             <a href="mailto:dani.q441@gmail.com" class="footer-links"><i class="fas fa-envelope"></i> dani.q441@gmail.com</a>
